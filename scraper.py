...
def main():
    ...
    scrape_status = {
        ...
        'counts': {},
        'sources': ['sarkariresult', 'freejobalert', 'sarkariexam', 'official_portals', 'internshala', 'freshersworld', 'remoteok', 'weworkremotely'],
        'error': None
    }
    ...
    try:
        ...
        for scraper_func in [scrape_sarkariresult, scrape_freejobalert, scrape_sarkariexam, scrape_official_portals, scrape_private_job_sites, scrape_remote_job_sites]:
